...
/**
 * Ação de devolução de livro.
 * Marca o empréstimo como devolvido e libera o exemplar.
 * Ao desfazer, restaura o estado de emprestado.
 */
public class AcaoDevolver implements Acao {
    ...
    public void executar() {
        ...
        if (multa > 0) {
            System.out.printf("⚠ Devolução com atraso de %d dia(s). Multa: R$ %.2f%n",
                    emprestimo.diasAtraso(), multa);
        } else {
