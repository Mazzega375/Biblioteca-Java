...
/**
 * Ação de cancelamento de uma reserva.
 * Altera o status da reserva para CANCELADA.
 * Ao desfazer, restaura o status para AGUARDANDO.
 */
public class AcaoCancelarReserva implements Acao {
    ...
    public void desfazer() {
        ...
        reservaRepo.salvar(reserva);
        System.out.println("↶ Cancelamento de reserva desfeito: " + reserva);
    }

    @Override
    public String descricao() {
        return String.format("Cancelamento da reserva #%d (ISBN '%s')",
                reserva.getId(), reserva.getIsbnLivro());
    }
}
