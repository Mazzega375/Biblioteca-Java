...
/**
 * Representa um usuário da biblioteca (aluno, professor ou bibliotecário).
 */
public class Usuario {
    ...
    /** Formato CSV: id;nome;email;tipo;bloqueado */
    public String toCsv() {
    ...
    public static Usuario fromCsv(String linha) {
        ...
        Usuario u = new Usuario(Integer.parseInt(p[0].trim()), p[1].trim(), p[2].trim(),
                Tipo.valueOf(p[3].trim()));
