...
public class Emprestimo {
    ...
    public double calcularMulta() {
        ...
        return diasAtraso > 0 ? diasAtraso * MULTA_POR_DIA : 0.0;
    }

    public long diasAtraso() {
        LocalDate ref = devolvido ? dataDevolucao : LocalDate.now();
        return Math.max(0, ChronoUnit.DAYS.between(dataPrevistaDevolucao, ref));
    }
    ...
    public String toCsv() {
        ...
        return String.join(";",
                ...
                dataEmprestimo.format(FMT), dataPrevistaDevolucao.format(FMT),
                dev, String.valueOf(devolvido));
    }
    ...
    public static Emprestimo fromCsv(String linha) {
        ...
        Emprestimo e = new Emprestimo(
                ...
                LocalDate.parse(p[3].trim(), FMT), LocalDate.parse(p[4].trim(), FMT));
